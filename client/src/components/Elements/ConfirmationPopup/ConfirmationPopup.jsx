...
const ConfirmationPopup = ({ handleProceed, handleCancel }) => {
    return (
        <div className="popup-container black-bg-trsp flex center">
            <div className="popupmain-inner-s white-bg flex column space-evenly border-radius-m">
                ...
                <div className="popup-btns flex center">
                    <Button color={'primary-btn'} size={'btn-s'} clickHandler={handleProceed} text={'Yes'} />
